...
public class PagesPath {
    ...
    public static final String PREPARATION_VS_COMPUTER = "/pages/preparation_VS_computer.jsp";
    public static final String PREPARATION_VS_SECOND_GAMER = "/pages/preparation_VS_secondGamer.jsp";
